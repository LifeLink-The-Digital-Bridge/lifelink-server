...
def get_ml_score(donation, request, model, scaler, label_encoders, feature_cols, metadata):
    try:
        features = {
            ...
            'donor_blood_type': str(donation.bloodType).replace('BloodType.', '').strip(),
            ...
            'recipient_blood_type': str(request.requestedBloodType).replace('BloodType.', '').strip(),
    ...
    tests = {
        "🩸 BLOOD TYPE COMPATIBILITY TESTS": [
            ("Perfect Match - O_NEGATIVE (Universal) to AB_POSITIVE (Universal)",
             {'bloodType': 'O_NEGATIVE', 'hemoglobinLevel': 16.0, 'age': 28, 'weight': 70.0, 'height': 175.0, 'bmi': 22.9,
             ...
             {'requestedBloodType': 'AB_POSITIVE', 'age': 50, 'weight': 80.0, 'height': 178.0, 'bmi': 25.2, 'hemoglobinLevel': 9.5,
              'bloodGlucoseLevel': 125.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'CRITICAL',
            ...
            ("Same Type Match - A_POSITIVE to A_POSITIVE",
             {'bloodType': 'A_POSITIVE', 'hemoglobinLevel': 15.0, 'age': 30, 'weight': 75.0, 'height': 180.0, 'bmi': 23.1,
             ...
             {'requestedBloodType': 'A_POSITIVE', 'age': 45, 'weight': 65.0, 'height': 170.0, 'bmi': 22.5, 'hemoglobinLevel': 10.5,
            ...
            ("BLOCKED - Incompatible A_POSITIVE to B_POSITIVE",
             {'bloodType': 'A_POSITIVE', 'hemoglobinLevel': 14.5, 'age': 35, 'weight': 68.0, 'height': 172.0, 'bmi': 23.0,
              ...
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'B_POSITIVE', 'age': 40, 'weight': 70.0, 'height': 175.0, 'bmi': 22.9, 'hemoglobinLevel': 11.0,
              'bloodGlucoseLevel': 105.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'MEDIUM',
            ...
            ("Rh Negative Donor to Rh Positive - B_NEGATIVE to B_POSITIVE",
             {'bloodType': 'B_NEGATIVE', 'hemoglobinLevel': 14.0, 'age': 33, 'weight': 72.0, 'height': 176.0, 'bmi': 23.3,
              ...
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'B_POSITIVE', 'age': 42, 'weight': 71.0, 'height': 174.0, 'bmi': 23.4, 'hemoglobinLevel': 11.2,
              'bloodGlucoseLevel': 108.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'MEDIUM',
        ...
        "🏥 MEDICAL CONDITION TESTS": [
            ("BLOCKED - Low Hemoglobin",
             {'bloodType': 'B_POSITIVE', 'hemoglobinLevel': 11.5, 'age': 32, 'weight': 60.0, 'height': 165.0, 'bmi': 22.0,
              'bloodGlucoseLevel': 95.0, 'hasDiabetes': False, 'hasDiseases': False, 'hasInfectiousDiseases': False,
              'medicalClearance': True, 'recentTattoo': False, 'recentVaccination': False, 'recentSurgery': False,
              'daysSinceLastDonation': 90, 'smokingStatus': 'NEVER_SMOKED', 'packYears': 0,
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'SMALL', 'quantity': 350},
             {'requestedBloodType': 'B_POSITIVE', 'age': 38, 'weight': 72.0, 'height': 176.0, 'bmi': 23.2, 'hemoglobinLevel': 10.0,
              'bloodGlucoseLevel': 110.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'HIGH',
            ...
            ("BLOCKED - Infectious Diseases",
             {'bloodType': 'O_POSITIVE', 'hemoglobinLevel': 15.0, 'age': 30, 'weight': 75.0, 'height': 180.0, 'bmi': 23.1,
              'bloodGlucoseLevel': 95.0, 'hasDiabetes': False, 'hasDiseases': False, 'hasInfectiousDiseases': True,
              'medicalClearance': True, 'recentTattoo': False, 'recentVaccination': False, 'recentSurgery': False,
              'daysSinceLastDonation': 120, 'smokingStatus': 'NEVER_SMOKED', 'packYears': 0,
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'O_POSITIVE', 'age': 45, 'weight': 65.0, 'height': 170.0, 'bmi': 22.5, 'hemoglobinLevel': 10.5,
              'bloodGlucoseLevel': 110.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'HIGH',
              'daysWaiting': 5, 'smokingStatus': 'NEVER_SMOKED', 'packYears': 0, 'alcoholStatus': 'MODERATE_USE',
              'drinksPerWeek': 2, 'latitude': 17.445, 'longitude': 78.355, 'bodySize': 'MEDIUM', 'quantity': 450}),

            ("Healthy High Hemoglobin - A_NEGATIVE to A_NEGATIVE",
             {'bloodType': 'A_NEGATIVE', 'hemoglobinLevel': 16.5, 'age': 25, 'weight': 65.0, 'height': 172.0, 'bmi': 21.9,
              ...
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'A_NEGATIVE', 'age': 60, 'weight': 58.0, 'height': 162.0, 'bmi': 22.1, 'hemoglobinLevel': 10.2,
            ...
            ("Diabetic Donor - O_POSITIVE to O_POSITIVE",
             {'bloodType': 'O_POSITIVE', 'hemoglobinLevel': 14.5, 'age': 42, 'weight': 85.0, 'height': 176.0, 'bmi': 27.4,
             ...
             {'requestedBloodType': 'O_POSITIVE', 'age': 38, 'weight': 68.0, 'height': 170.0, 'bmi': 23.4, 'hemoglobinLevel': 9.8,
        ...
        "⚠️ LIFESTYLE & RISK TESTS": [
            ("Smoker Donor - A_POSITIVE to A_POSITIVE",
             {'bloodType': 'A_POSITIVE', 'hemoglobinLevel': 14.0, 'age': 45, 'weight': 80.0, 'height': 178.0, 'bmi': 25.2,
              ...
              'bodySize': 'LARGE', 'quantity': 450},
             {'requestedBloodType': 'A_POSITIVE', 'age': 35, 'weight': 65.0, 'height': 168.0, 'bmi': 23.0, 'hemoglobinLevel': 11.5,
              'bloodGlucoseLevel': 100.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'MEDIUM',
            ...
            ("Heavy Alcohol Use - B_POSITIVE to B_POSITIVE",
             {'bloodType': 'B_POSITIVE', 'hemoglobinLevel': 13.5, 'age': 38, 'weight': 78.0, 'height': 174.0, 'bmi': 25.7,
              ...
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'B_POSITIVE', 'age': 44, 'weight': 75.0, 'height': 171.0, 'bmi': 25.6, 'hemoglobinLevel': 10.8,
            ...
            ("Recent Tattoo - AB_NEGATIVE to AB_NEGATIVE",
             {'bloodType': 'AB_NEGATIVE', 'hemoglobinLevel': 14.5, 'age': 29, 'weight': 68.0, 'height': 170.0, 'bmi': 23.5,
             ...
             {'requestedBloodType': 'AB_NEGATIVE', 'age': 55, 'weight': 62.0, 'height': 164.0, 'bmi': 23.0, 'hemoglobinLevel': 9.8,
        ...
        "🚨 URGENCY PRIORITY TESTS": [
            ("Critical Urgency - O_POSITIVE to A_POSITIVE",
             {'bloodType': 'O_POSITIVE', 'hemoglobinLevel': 16.5, 'age': 26, 'weight': 72.0, 'height': 177.0, 'bmi': 23.0,
              'bloodGlucoseLevel': 88.0, 'hasDiabetes': False, 'hasDiseases': False, 'hasInfectiousDiseases': False,
              'medicalClearance': True, 'recentTattoo': False, 'recentVaccination': False, 'recentSurgery': False,
              'daysSinceLastDonation': 200, 'smokingStatus': 'NEVER_SMOKED', 'packYears': 0,
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 500},
             {'requestedBloodType': 'A_POSITIVE', 'age': 18, 'weight': 55.0, 'height': 165.0, 'bmi': 20.2, 'hemoglobinLevel': 8.5,
              'bloodGlucoseLevel': 90.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'CRITICAL',
            ...
            ("Low Urgency - B_NEGATIVE to B_NEGATIVE",
             {'bloodType': 'B_NEGATIVE', 'hemoglobinLevel': 13.8, 'age': 40, 'weight': 70.0, 'height': 172.0, 'bmi': 23.6,
              'bloodGlucoseLevel': 100.0, 'hasDiabetes': False, 'hasDiseases': False, 'hasInfectiousDiseases': False,
              'medicalClearance': True, 'recentTattoo': False, 'recentVaccination': False, 'recentSurgery': False,
              'daysSinceLastDonation': 125, 'smokingStatus': 'FORMER_SMOKER', 'packYears': 5,
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 450},
             {'requestedBloodType': 'B_NEGATIVE', 'age': 62, 'weight': 60.0, 'height': 165.0, 'bmi': 22.0, 'hemoglobinLevel': 10.5,
        ...
        "📦 QUANTITY MISMATCH TESTS": [
            ...
            ("Sufficient Quantity - O_NEGATIVE to B_POSITIVE",
             {'bloodType': 'O_NEGATIVE', 'hemoglobinLevel': 15.2, 'age': 31, 'weight': 73.0, 'height': 176.0, 'bmi': 23.5,
              'bloodGlucoseLevel': 92.0, 'hasDiabetes': False, 'hasDiseases': False, 'hasInfectiousDiseases': False,
              'medicalClearance': True, 'recentTattoo': False, 'recentVaccination': False, 'recentSurgery': False,
              'daysSinceLastDonation': 140, 'smokingStatus': 'NEVER_SMOKED', 'packYears': 0,
              'alcoholStatus': 'NO_ALCOHOL_USE', 'drinksPerWeek': 0, 'latitude': 17.4399, 'longitude': 78.3489,
              'bodySize': 'MEDIUM', 'quantity': 500},
             {'requestedBloodType': 'B_POSITIVE', 'age': 41, 'weight': 70.0, 'height': 175.0, 'bmi': 22.9, 'hemoglobinLevel': 10.8,
              'bloodGlucoseLevel': 108.0, 'hasDiabetes': False, 'hasInfectiousDiseases': False, 'urgencyLevel': 'MEDIUM',
